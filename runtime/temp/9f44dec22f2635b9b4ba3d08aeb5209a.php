<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/opt/web/hqy/public/../application/v1/view/organization/editorg.html";i:1569221377;s:51:"/opt/web/hqy/application/v1/view/layout/dialog.html";i:1544600118;s:49:"/opt/web/hqy/application/v1/view/common/meta.html";i:1564043319;s:51:"/opt/web/hqy/application/v1/view/common/script.html";i:1564371933;}*/ ?>
<!DOCTYPE html>
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control selectpicker show-tick" data-live-search="true" id="pid" name="pid" disabled="disabled"  data-msg-required="请选择">
                            ...
                            <option value="<?php echo $items['id']; ?>" <?php if($list['pid'] == $items['id']): ?>selected='selected'<?php endif; ?>><?php echo $items['title']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="title" name="title" value="<?php echo $list['title']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control selectpicker show-tick" data-live-search="true" title="" id="manage_uid" name="manage_uid">
                            ...
                            <option value="<?php echo $key; ?>" <?php if($list['manage_uid'] == $key): ?>selected='selected'<?php endif; ?>><?php echo $vo; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" id="weigh" name="weigh" value="<?php echo isset($list['weigh'])?$list['weigh']: 1; ?>">
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="admin_module.save_btn(this)" data-url="<?php echo url('v1/organization/editorg'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
