<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/opt/web/hqy/public/../application/v1/view/organ/organization/addorg.html";i:1571297861;s:51:"/opt/web/hqy/application/v1/view/layout/dialog.html";i:1544600118;s:49:"/opt/web/hqy/application/v1/view/common/meta.html";i:1564043319;s:51:"/opt/web/hqy/application/v1/view/common/script.html";i:1564371933;}*/ ?>
<!DOCTYPE html>
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="admin_module.save_btn(this)" data-url="<?php echo url('/v1/organ/organization/addorg'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
