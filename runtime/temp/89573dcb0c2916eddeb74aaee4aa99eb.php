<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:66:"/opt/web/hqy/public/../application/v1/view/organization/index.html";i:1571129637;s:52:"/opt/web/hqy/application/v1/view/layout/default.html";i:1564049557;s:49:"/opt/web/hqy/application/v1/view/common/meta.html";i:1564043319;s:51:"/opt/web/hqy/application/v1/view/common/header.html";i:1564379630;s:49:"/opt/web/hqy/application/v1/view/common/left.html";i:1571208094;s:61:"/opt/web/hqy/application/v1/view/organization/index_form.html";i:1571129745;s:62:"/opt/web/hqy/application/v1/view/organization/index_table.html";i:1571128950;s:51:"/opt/web/hqy/application/v1/view/common/footer.html";i:1564047127;s:51:"/opt/web/hqy/application/v1/view/common/script.html";i:1564371933;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <!-- 加载样式及META信息 -->
...
<div class="wrapper">
    ...
    <section class="sidebar" style="height: auto;">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if($paths == '/v1/systematic/system/menu' || $paths == 'v1/organization/index'): ?>active<?php endif; ?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php if($paths == 'v1/organization/index'): ?>active<?php endif; ?>">
                        <a href="<?php echo url('/v1/organization/index'); ?>"><i class="fa fa-circle-o"></i>组织架构管理</a>
                    </li>
                    <li class="<?php if($paths == 'v1/system/setting'): ?>active<?php endif; ?>">
                        <a href="<?php echo url('/v1/system/setting'); ?>"><i class="fa fa-circle-o"></i>系统设置</a>
                    </li>
                </ul>
            </li>
...
<table class="table table-striped table-bordered table-hover">
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_list): $mod = ($i % 2 );++$i;?>
        <tr>
            ...
            <td class="td-align td-padding">
                <a href="javascript:void(0)" class="btn btn-info" data-url="<?php echo url('v1/organization/editorg'); ?>" data-id="<?php echo $data_list['id']; ?>" onclick="admin_module.edit_org(this)">编辑</a>
            </td>
        </tr>
